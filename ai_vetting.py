...
def generate_vetting_analysis(referral_text, modality_hint=None, protocol_titles=None):
    ...
    user_prompt = (
        ...
        "coverage, and technique. Use this to pick the correct protocol.\n"
        "- Match the clinical scenario to the MOST SPECIFIC appropriate protocol.\n"
        "- For trauma/injury/falls: pick the routine non-contrast protocol, not oncology staging.\n"
        "- For known malignancy/staging: pick the tumour-specific staging protocol if available.\n\n"
