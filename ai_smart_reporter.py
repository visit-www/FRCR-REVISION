...
CBCT_ASSIST_SYSTEM_PROMPT = (
    ...
    "the context fits):\n"
    "- Images not to scale (STANDING FOOTER — always include; illustrative images are always "
    "attached with this service): \"Please note: Images seen here are for illustrative purposes "
