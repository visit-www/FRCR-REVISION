...
CBCT_ASSIST_SYSTEM_PROMPT = (
    ...
    "the context fits):\n"
    "- Images not to scale (include whenever illustrative images accompany the report): \"Please "
    "note: Images seen here are for illustrative purposes only and are not 'to scale'.\"\n"
