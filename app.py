...
def _build_ai_discussion_html(output, provider, model_name):
    ...
    # Header with RadInsights attribution — subtle, doesn't compete with content
    header = (
        '<hr style="border-top: 1px solid #dee2e6; margin: 0.75rem 0;">'
        f'<p style="color: #8b94a3; font-size: 0.82em; font-style: italic; margin: 0 0 0.75rem 0;">'
        f'Generated by RadInsights Intelligence'
        f' on { _escape_html(timestamp) }</p>'
    )
